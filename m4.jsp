...
String a3=request.getParameter("e3");

String a4=request.getParameter("easy");
%>
...
String s1="aaa",s2="",s3="",s4="",s5="";
	...
	try{
		Class.forName("com.mysql.jdbc.Driver");
			...
			rs=stmt.executeQuery( "Select * From `medium` where id='m5' ");
...
<input type=hidden name=e4 value="<%=a4%>">
